...
rows=[['Joint','Standard hardware','Nominal stack / access'],['Motherboard posts','ATX-height brass standoff: M3 male × M3 female, 6.5 mm body, 5 mm hex, 6 mm stud; M3 × 5 motherboard screws','Stud threads into an extruded M3 thread in the 2 mm tray: 3.5 engagement. Screw through 1.57 PCB → 3.43 engagement. No washers.'],['Backplane posts','M3 × 8 mm female–female brass hex standoff, 5 mm AF','Lower M3 × 6: 0.5 washer + 2 crossbar → 3.5 engagement. Upper M3 × 6: 0.5 washer + 2.5 PCB → 3.0 engagement. Tip gap 1.5.'],['Crossbar clamp','M4 × 8 pan-head; DIN 562 M4 square thin nut, 7 AF × 2.2','4 mm combined crossbar/rail, full 2.2 mm nut engagement. Nuts remain between guide strips. Tighten before the PCB is installed.'],['Rail boss','M4 × 6 pan-head','2 rail on a 4.5 mm boss formed in the GPU tray; 1.5 boss top + 1.5 extruded collar → 3.0 thread engagement.'],['PCIe retention','M3 × 5 pan head; no nuts','GPU shelf: integral 1.2 mm bend with 21 extruded collars tapped M3, 2.5 thread length (five turns). Lower bank: separate 1.5 mm strip with eight extruded collars tapped M3, 3.0 thread length. Tap drill 2.5. The PSU keeps its #6-32 screws, which thread into the PSU.'],['Panels, brackets and lid','M3 and M4 pan-head screws into extruded tapped threads; four M3 × 6 pan-head lid pin screws','Each screw threads into an extruded collar in the sheet opposite its head: M3 tap drill 2.5, M4 tap drill 3.3, collar one sheet thickness tall (1.5 maximum). The lid slides on the four pin screws, whose threads are tapped directly in the walls, and is retained by two M3 × 6 screws through its rear tabs into the rear cover.'],['Chassis fan mounts','M5 × 10 self-tapping case-fan screws; no nuts','2 carrier leaves 8 mm nominal penetration into GPU fan plastic. Rear 1.2 panel leaves 8.8 mm. No inlet spacers. Grille access holes: 8.8 mm. Use fan-approved screws; AIO hardware is separate.']]
if mod:rows[-1]=['GPU fan mounts','M5 × 10 self-tapping case-fan screws; no nuts','Padded 120/140 mm fans: 2 carrier + 1 front pad leave 7 mm penetration. 80/180 mm fans: 2 carrier leaves 8 mm. '+'; '.join(f"{r['size_mm']} mm: {r['hole_pitch_mm']:g} square pitch" for r in fan_rows)+'. Use fan-approved screws.']
...
if not mod:
 ...
 y=para('Ten nominal SSI EEB locations are selected to match the ten holes circled in the ASUS WRX90E-SAGE SE manual (printed page 2-13). SSI EEB 2011 v1.0.1 Figure 2 gives the dimensional datum. The motherboard PCB underside is Z16.00; tray top Z9.50; standard ATX standoffs 6.50. The hole map below uses the exported assembly datum.',32,H-85,1120,12)
...
if mod:
 ...
 para('To change option: remove the grille, unscrew the fans, remove the side screws and withdraw the carrier forward, then fit the other carrier, fans and grille. Padded 120 and 140 mm fans sit on 1 mm front pads, leaving 7 mm screw penetration into the plastic frame; 80 and 180 mm frames seat directly on the 2 mm carrier, leaving 8 mm. Confirm screw suitability with each fan supplier.',32,300,W-64,11)
