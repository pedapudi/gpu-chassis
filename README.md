...
- [Download the complete engineering package](https://github.com/pedapudi/gpu-chassis/releases/tag/engineering-specificity-2026-09-22)
...
```sh
python3 scripts/prepare_pages.py chassis-engineering-specificity.zip --out _site
