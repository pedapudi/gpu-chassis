...
- Resolve the flanges shorter than the usual press-brake minimum of four thicknesses (6 mm for 1.5 mm steel): the 4.0 mm lower lips of both rear covers, the 2 mm flat tops of the tray stiffening channels, and the 4.5 mm legs of the backplane-rail and motherboard-tray bridges. The surrounding height stack fixes these sizes. Form them oversize and trim, use dedicated tooling, or substitute bought channels and spacers.
