...
Motherboard locations follow the SSI EEB dimensional drawing and the ten selected mounting holes in the ASUS manual. Use only those ten posts. The board has seven PCIe 5.0 x16 slots; one runs in x8 mode, which limits the retimer in that slot. The motherboard posts are ATX-height brass standoffs: M3 male by M3 female, a 6.5 mm body with a 5 mm hex, and a 6 mm stud. The board fixes to them with M3 × 5 motherboard screws and no washers. The backplane posts are common M3 × 8 mm female–female brass hex standoffs, 5 mm across flats.

The motherboard standoffs screw into M3 threads extruded downward from the 2 mm tray. Sheet and collar give 3.5 mm of thread, and each stud tip stops 2.0 mm above the body floor. The tray top is at Z9.5, so the board underside sits 6.5 mm above it at Z16, meeting the ATX minimum clearance of 0.25 in. The motherboard screws engage 3.43 mm. The tray screws down onto four conical bosses embossed 6 mm up from the 1.5 mm body floor; each boss top carries an extruded M3 thread with 3.0 mm of engagement. Backplane crossbars are prepared on the bench with screws entering the posts from below. They clamp from above into standard DIN 562 M4 square thin nuts that slide between sheet guide strips under the rails. Load those nuts before fixing the rails. The rail ends screw into four M4-tapped bosses embossed 4.5 mm up from the GPU tray. Set the posts and crossbars before fitting the PCB.

Wherever a screw fastens into a sheet part, that sheet carries an extruded collar tapped M3 (2.5 mm drill) or M4 (3.3 mm drill) on the side away from the screw head. The chassis has no inch threads; only the four PSU screws are #6-32, and they thread into the PSU. The collar height equals the sheet thickness, up to 1.5 mm, so a 1.5 mm sheet gives 3.0 mm of thread and a 1.2 mm sheet gives 2.4 mm. The four lid pin threads in the body walls are the exception: they are tapped directly in the 1.5 mm sheet, without a collar, so the lid returns can lie flat against the walls. The pins carry shear, not clamping load. Each blank's record in `flat_patterns/flat_patterns.json` lists its formed threads, and the fabrication kit's `tapped_thread_schedule.csv` collects them. The only loose nuts in either chassis are the DIN 562 square nuts in the rail guides. Qualify the formed threads for tightening torque and repeated service.

GPU bracket screws are M3 × 5 pan-head screws that thread into the integral 1.2 mm rear-panel shelf. PCIe brackets have an open slot that takes either M3 or #6-32 screws; M3 gives five thread turns in the 2.5 mm formed thread, against about three for #6-32. The shelf has a 90-degree outward bend with R1.2 inside and R2.4 outside. Its bearing height and screw axes match the brackets. Each screw axis has an extruded collar, 3.7 mm outside diameter and 1.3 mm below the shelf, tapped M3 from a 2.5 mm drill. Shelf and collar give 2.5 mm of thread. No nuts sit beneath the shelf, so the rear web needs no nut reliefs and every web between apertures joins the bend. Each collar edge lies 0.83 mm from the bend tangent, inside the press-brake die footprint, so the shelf is formed first and the collars are extruded and tapped afterward. Qualify thread strength for tightening torque and repeated GPU service. The lower motherboard bank has a separate 1.5 mm retention strip with eight M3 threads in 1.5 mm collars, giving 3.0 mm of thread.

## Assembly and service

1. Form and deburr panels and emboss the bosses. Extrude and tap each formed thread after the adjacent bends are made. Bolt each separate 3 mm rack ear to the body with M4 × 10 screws into the tapped body walls; the ears are not welded. Apply a finish compatible with the chosen hardware and mask the threads.
2. Screw the ten motherboard standoffs into the bare tray on the bench. Screw the empty tray onto its floor bosses, then fit the motherboard. Fit the lower exhaust fans after the tray; one fan covers a rear tray screw.
3. Install the PSU before the adjacent upper bearing angle. Fit the AIO, motherboard cooler and retimers with the GPU cartridge removed. PSU replacement requires removing that bearing angle.
4. Load the square nuts into the rail guides and screw the rails onto the GPU tray bosses. Prepare crossbars and posts on the bench, clamp the crossbars from above, attach the backplane, then install the GPUs, the single-width card and their rear retention screws.
...
7. Install the perforated rear cover, then the lid. Pan-head M3 screws through the body walls thread into the cover's side returns: two per side on the 9U, one per side on the module. The lid slides on four M3 × 6 pan-head screws threaded from outside into the body walls; their shanks engage L-slots in its side returns. Those wall threads are tapped directly in the 1.5 mm sheet, without a collar, so the lid returns lie flat. Lower the lid 10 mm behind its seated position, slide it forward against the front carrier, then fit two M3 × 6 retention screws through its rear tabs into threads in the cover. To remove the lid, take out those two screws, slide it 10 mm rearward and lift it. To remove the cartridge, also remove the cover, disconnect the cartridge cables and remove the cartridge hold-down screws.
...
The grille has independent M3 fasteners. Its 8.8 mm fan-head access holes allow removal without loosening the GPU fans. Chassis fans use the common M5 × 10 mm self-tapping case-fan screw, which forms threads in the plastic frame. The 9U GPU fans seat directly against the 2 mm carrier, leaving 8 mm nominal penetration including the tapered lead. In the module, padded 120 and 140 mm fans sit on 1 mm front corner pads, leaving 7 mm penetration into plastic; 80 and 180 mm frames seat on the 2 mm carrier, leaving 8 mm. Each fan uses four screws and no nuts. The 9U rear exhaust fans use the same screw through the 1.2 mm rear panel, leaving 8.8 mm penetration. GPU and rear fan slots are 5.5 mm wide; the AIO mounting slots and fasteners retain their separate specification. Screw heads are modeled as 8.5 mm diameter. Select fan-approved screws and confirm the actual plastic lug depth; these dimensions are nominal procurement envelopes.

Each 3 mm rack ear has a 64 mm side leg and two rows of M4 mounting screws. The 9U ear has six side screws; the module ear has four. The screws thread into extruded M4 collars in the 1.5 mm body walls, giving 3.0 mm of thread. Screw tips and collars are included in static checks. Rack rails or a rated shelf carry the loaded chassis; the ear joints still require structural qualification.
...
- Resolve the flanges shorter than the usual press-brake minimum of four thicknesses (6 mm for 1.5 mm steel): the 4.0 mm lower lips of both rear covers. The surrounding height stack fixes this size. Form the lips oversize and trim, or use dedicated tooling.
- Emboss the eight conical bosses in 1.5 mm steel with a forming die: four in the body floor (23 mm base, 10 mm top, 6 mm rise) and four in the GPU tray (20 mm base, 10 mm top, 4.5 mm rise). A fabricator without one can substitute M3 and M4 press-in standoffs of the same height.
- Accept or relocate holes closer than two thicknesses to a bend line. The EIA-310 rack holes sit 3.05 mm from the rack-ear bend because the rack standard fixes their positions; the M4 side-screw holes in the ear's side leg sit 5.7 mm from the same bend, against a 6 mm guideline. On the GPU rear panel, the outermost aperture sits 0.95 mm from the side-return bend; the backplane socket pitch fixes it, and the board leaves only 1 mm of side clearance for a shift. The shelf tap-drill holes sit 1.43 mm from the shelf bend, which is acceptable only because the collars are extruded after bending. `formed_part_checks.json` lists every case.
...
| --- | --- | --- | --- | --- |
| 3 × 140 mm | 140 × 25: X78, 220, 362; Z330 | 124.5 square | DIA136 | 7 mm through 1 mm pad |
| 3 × 120 mm + 5 × 80 mm | 120 × 25: X78, 220, 362; Z299. 80 × 25: X52, 136, 220, 304, 388; Z401 | 105 square; 71.5 square | DIA116; DIA76 | 7 mm (120 mm, padded); 8 mm (80 mm) |
| 2 × 180 mm | 180 × 32: X128, 312; Z330 | 165 square | DIA175 | 8 mm |
...
To change option, remove the grille, unscrew the fans, remove the carrier side screws and withdraw the carrier forward. Fit the other carrier, its fans and the grille. All fans use M5 × 10 mm self-tapping case-fan screws without nuts; confirm screw suitability and retention torque with each fan supplier.
...
Both inserts have horizontal clearance slots 5.5 mm wide with R 2.75 ends. Outer slots are 9 mm long. Shared slots are 24.5 mm long for the 180 mm pair and 24 mm for the 120 mm row. Four M5 × 10 mm self-tapping case-fan screws per fan penetrate 8 mm into plastic, including the tip. Confirm the selected fan's approved screw and retention torque.

The carrier has a 392 ×222 opening, leaving 1 mm clearance at each insert edge. A factory-attached 398 ×240 ×2 mm backing ring provides a 370 ×200 clear window behind it. Six M3 ×8 screws enter from the front and thread into M3 collars extruded rearward from the 2 mm ring, giving 3.5 mm of thread. The modeled joint has 4 mm of sheet and a 1.5 mm collar, with 2.5 mm nominal tip projection. The ring remains fixed when the insert is removed; qualify its attachment strength and distortion before fabrication.
