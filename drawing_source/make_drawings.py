...
if mod:
 ...
 steps[2]=('Attach adapter before upper components','Fix the adapter to the OEM body using the verified original interface. Attach the empty upper U-body to the adapter from above, using its captive nuts. Install the bearing angles, rails, fans and cartridge only after these screws are tightened; the side bearing angles cover four of them.')
if mod:
...
rows=[['Joint','Standard hardware','Nominal stack / access'],['Motherboard posts','Harwin R30-1000802; 8 mm, M3 female–female, 5 mm AF','Lower M3 × 6: 0.5 washer + 2 tray → 3.5 engagement. Upper M3 × 5: 0.5 washer + 1.57 PCB → 2.93 engagement. Tips separated 1.57.'],['Backplane posts','Same 8 mm female–female part','Lower M3 × 6: 0.5 washer + 2 crossbar → 3.5 engagement. Upper M3 × 6: 0.5 washer + 2.5 PCB → 3.0 engagement. Tip gap 1.5.'],['Crossbar clamp','M4 × 8 pan-head; DIN 562 M4 square thin nut, 7 AF × 2.2','4 mm combined crossbar/rail, full 2.2 mm nut engagement. Nuts remain between guide strips. Tighten before the PCB is installed.'],['Rail bridge clamp','M4 × 6; DIN 562 M4 square thin nut','2 rail + 1.5 bridge + 2.2 nut. Captive nut fitted before bridge is welded.'],['PCIe retention','6-32 UNC × 1/4 in; standard #6-32 hex nut on the lower bank only','GPU shelf: integral 1.2 mm bend with 21 extruded collars tapped #6-32 UNC-2B; tap drill 2.705; 2.5 thread length; no nuts. Lower bank: separate 1.5 mm strip, 3.9 clearance bores, nuts 7.9375 AF × 2.778 high captured before rear-panel installation.'],['Side panels and lid','M3 pan-head screws; M3 nuts captured during fabrication','Lengths are instance-specific in BOM. Hardware near the PSU uses M3 × 6 with a 0.5 washer.'],['Chassis fan mounts','5 × 8 self-tapping plastic fan screws; no nuts','2 carrier leaves 6 mm nominal penetration into GPU fan plastic. Rear 1.2 panel leaves 6.8 mm. No inlet spacers. Grille access holes: 8.8 mm. Use fan-approved screws; AIO hardware is separate.']]
...
if mod:
 ...
 para('Each intake option has its own removable front carrier, fastened by four M3 screws per side through the body into captive nuts on the carrier returns. One full-face grille serves all options: it has 8.8 mm tool-access holes at every fan screw axis of every option and five M3 fixings on lands clear of all fan frames.',32,H-82,W-64,11)
