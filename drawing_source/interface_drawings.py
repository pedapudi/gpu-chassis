...
def interface_details(parts,mod,api):
    ...
    if mod:
        ...
        sheet('Lower rear | hardware functions and mounting datums','Lower_rear_1p2mm_IO_eight_slots_exhaust_side_returns',[
            ...
            ['Motherboard I/O aperture','158.750 ×44.450. Minimum X168.6884/Z13.7648; maximum X327.4384/Z58.2148. The separate 1.2 mm I/O carrier provides the finished shield land.'],
