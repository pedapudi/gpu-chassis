...
1. Form and deburr panels and emboss the bosses. Extrude and tap each formed thread after the adjacent bends are made. Press the captive thumbscrews into the body walls after finishing. Bolt each separate 3 mm rack ear to the body with M4 × 10 screws into the tapped body walls; the ears are not welded. Apply a finish compatible with the chosen hardware and mask the threads.
...
7. Install the perforated rear cover, then the lid. Each is held by four M3 captive thumbscrews whose press-fit ferrules stay in 6.4 mm holes in the body walls. The knurled heads project 4 mm beyond the body sides; confirm clearance to the selected rack slides. To remove the cartridge, disconnect its cables, loosen the thumbscrews, lift off the lid and rear cover, then remove the cartridge hold-down screws.
