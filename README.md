...
- [Download the complete engineering package](https://github.com/pedapudi/gpu-chassis/releases/tag/engineering-drawings-2026-09-22)
...
The viewers show a 3D model beside selectable, zoomable engineering drawing sheets. Selecting a fabricated component opens its corresponding drawing. The release includes STEP assemblies and individual parts, OpenSCAD geometry, PDF drawings, coordinate schedules and validation reports. Drawing schedules specify hole diameters and radii, slot lengths and end radii, local sheet thickness and feature positions. Dedicated GPU rear-interface sheets dimension the bracket apertures, retention bend and toe-locator attachment.
...
```sh
python3 scripts/prepare_pages.py chassis-engineering-detailed.zip --out _site
