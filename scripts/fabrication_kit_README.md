...
- `hardware_list.csv`: purchased screws, lid locating studs, square nuts, washers and standoffs, with quantities per configuration.
...
Deburr all edges. Weld joined assemblies before finishing, then zinc plate or powder coat. Mask the tapped threads during finishing. Press in the lid locating studs afterward.
...
The lid slides on four flush-head press-in studs, 4 mm diameter, in the body walls, and two M3 screws through its rear tabs into the rear cover retain it. Side screws through the body walls hold the rear cover.
